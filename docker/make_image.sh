...
rm ./tmp.cid
nvidia-docker run --cidfile tmp.cid -it $1 pip install --global-option="--no-networks" git+https://github.com/NVlabs/tiny-cuda-nn/@749dd70#subdirectory=bindings/torch
